...
def ride_resource():
    ...
    rides = [{"id":1, "destination":"Nairobi", "departure_point":"Eldoret", "fare":800, "driver":{"username":"Jesse", "gender":"male"}, "requests":{"jane":"accepted","jack":"accepted","frank":"accepted","florence":"rejected"},
